...
struct ctrl_coalescing_store_dotx_t
{
    ...
    // co_m_update_os_functor = None  // update offset based on current i_m. otherwise use sgpr to
    // update offset co_m_flag_check_start_functor = None co_m_flag_check_reset_functor = None
