...
extern "C" __global__ __launch_bounds__(256, 2) void tensor_cast_fp16_fp32_1d(
    half *output, float *input, int total_length) {
...
extern "C" __global__ __launch_bounds__(256, 2) void tensor_cast_bf16_fp32_1d(
    ushort *output, float *input, int total_length) {
    constexpr auto unroll_length = 8;
    float vec_in_data[unroll_length];
